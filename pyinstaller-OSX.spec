...
a = Analysis(['src/Main.py'],
             ...
             datas=[('src/Images/*', 'Images'),
                    ...
                    ('<python-site-packages-path>/wordcloud/stopwords', 'wordcloud' ),
                    ('<python-site-packages-path>/wordcloud/DroidSansMono.ttf', 'wordcloud' ),
                    ('<python-site-packages-path>/xmlschema/schemas', 'xmlschema/schemas')],
