...
a = Analysis(['src\\Main.py'],
             ...
             binaries=[],
             datas=[('src/Images/*', 'Images'), ('C:/Program Files/Python39/Lib/site-packages/wordcloud/stopwords', 'wordcloud' ), ('C:/Program Files/Python39/Lib/site-packages/wordcloud/DroidSansMono.ttf', 'wordcloud' )],
